...
const t: ShipType = {
  ...
  ability: {
    name: {
      en: 'Hyperspace Docking Ring',
      de: 'Hyperraum-Andockring',
      es: 'Anillo de atraque hiperespacial',
      fr: "Anneau d'arrimage Hyperspatial",
    },
    text: {
      en:
