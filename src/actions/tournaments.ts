...
export type TournamentChangeNameAction = {
  type: typeof TOURNAMENT_CHANGE_NAME;
  tournamentUid: string;
  name: string;
};

export type TournamentChangeDateAction = {
  type: typeof TOURNAMENT_CHANGE_DATE;
  tournamentUid: string;
  date: number;
};
export type TournamentChangeFormatAction = {
  type: typeof TOURNAMENT_CHANGE_FORMAT;
  tournamentUid: string;
  format: Format;
};
...
export const changeTournamentName = (
  tournamentUid: string,
  name: string
): TournamentChangeNameAction => ({
  type: TOURNAMENT_CHANGE_NAME,
  tournamentUid,
  name,
});

export const changeTournamentDate = (
  tournamentUid: string,
  date: number
): TournamentChangeDateAction => ({
  type: TOURNAMENT_CHANGE_DATE,
  tournamentUid,
  date,
});

export const changeTournamentFormat = (
  tournamentUid: string,
  format: Format
): TournamentChangeFormatAction => ({
  type: TOURNAMENT_CHANGE_FORMAT,
  tournamentUid,
  format,
});
